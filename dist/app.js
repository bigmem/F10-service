...
app.use((0, _cookieParser.default)()); // app.use(sassMiddleware({
...
app.use('/list', _list.default);
app.use('/message', _message.default); // catch 404 and forward to error handler
